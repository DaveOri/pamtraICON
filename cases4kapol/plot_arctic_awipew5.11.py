...
for patch in patches:
  ...
  iconfile = '/data/inscape/icon/experiments/nyalesund/2016-11-05/METEOGRAM_patch'+patch+'_awipev.nc'
  datafile = '/data/optimice/pamtra_runs/nyalesund/20171105/METEOGRAM_awipev_patch'+patch+'.nc'
  plotpath = '/data/optimice/pamtra_runs/nyalesund/20171105/P'+patch+'_'
