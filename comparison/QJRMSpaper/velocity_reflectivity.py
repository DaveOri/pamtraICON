...
hpw, xpw, ypw = hist_and_plot(slice_data(pamtra, 'T', maxvalue=-2), 'Simulated MDVk - Zk', yvar='V35', xvar='Z35',
...
hpw, xpw, ypw = hist_and_plot(slice_data(ice, 'T', maxvalue=-2), 'Simulated MDVk - Zk only ICE', yvar='V35', xvar='Z35',
              xlabel='Zk   [dBZ]', ylabel='MDV Ka   [m/s]', #vminmax=[0.1, 100],
              xlim=[-40, 30], ylim=[-2, 1], lognorm=lognormrule,
...
hpw, xpw, ypw = hist_and_plot(slice_data(snow, 'T', maxvalue=-2), 'Simulated MDVk - Zk only SNOW', yvar='V35', xvar='Z35',
              xlabel='Zk   [dBZ]', ylabel='MDV Ka   [m/s]', #vminmax=[0.1, 100],
              xlim=[-40, 30], ylim=[-2, 1], lognorm=lognormrule,
...
hrx, xrx, yrx = hist_and_plot(slice_data(rad, 'T', maxvalue=-2), 'Measured MDVk - Zk', yvar='V35avg', xvar='Z35',
              xlabel='Zk   [dBZ]', ylabel='MDV Ka   [m/s]', #vminmax=[0.1, 100],
              xlim=[-40, 30], ylim=[-2, 1], lognorm=lognormrule,
