...
hist_and_plot(pamtra, 'sensitivity cone Ka', yvar='Hgt', xvar='Z35',
              ...
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/pamtraCFAD_Zk_Hgt.png',
              inverty=False, figax=None,
              bins=(100,icon100heights[::-1]))
...
hist_and_plot(pamtra, 'sensitivity cone W', yvar='Hgt', xvar='Z94',
              xlabel='Zx   [dBZ]', ylabel='Hgt   [m]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/pamtraCFAD_Zw_Hgt.png',
              inverty=False, figax=None,
              bins=(100,icon100heights[::-1]))
...
hist_and_plot(radar.dropna(subset=['Z35']), 'sensitivity cone Ka',
              ...
              xlabel='Zk   [dBZ]', ylabel='Hgt   [m]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/radarCFAD_Zk_Hgt.png',
              inverty=False, figax=None,
              bins=(100,Hr_b))
...
hist_and_plot(radar.dropna(subset=['V35']), 'MDV Ka',
              ...
              savename='tripex/'+hydroset+'/radarCFAD_V35_T.png',
...
hist_and_plot(radar.dropna(subset=['V10']), 'MDV X',
              ...
              xlim=[-5, 2], ylim=[-30, 10], lognorm=True,
              savename='tripex/'+hydroset+'/radarCFAD_V10_T.png',
              inverty=True, figax=None,
              bins=(80,100))
...
hist_and_plot(radar.dropna(subset=['V94']), 'MDV W',
              ...
              xlim=[-5, 2], ylim=[-30, 10], lognorm=True,
              savename='tripex/'+hydroset+'/radarCFAD_V94_T.png',
              inverty=True, figax=None,
              bins=(800,200))
...
hist_and_plot(radar.dropna(subset=['Z10']), 'sensitivity cone X',
              ...
              savename='tripex/'+hydroset+'/radarCFAD_Zx_Hgt.png',
              inverty=False, figax=None,
              bins=(100,Hr_b))
...
hist_and_plot(radar.dropna(subset=['Z94']), 'sensitivity cone W',
              ...
              xlabel='Zx   [dBZ]', ylabel='Hgt   [m]',
              xlim=[-60, 50], ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/radarCFAD_Zw_Hgt.png',
              inverty=False, figax=None,
              bins=(100,Hr_b))
radar = slice_data(radar, 'quality_x', maxvalue=8192)
...
hist_and_plot(pamtra, '3f plot all', yvar='DWRxk', xvar='DWRkw',
              ...
              savename='tripex/'+hydroset+'/pamtra3f_all.png', inverty=False, figax=None,
              bins=100)
...
plt.legend()
plt.savefig('tripex/'+hydroset+'/pamtra3f_all_withcurves.png')

hist_and_plot(slice_data(pamtra, 'T', maxvalue=0),
              '3f plot T<0', yvar='DWRxk', xvar='DWRkw',
              xlabel='DWR Ka W   [dB]', ylabel='DWR X Ka   [dB]',
              xlim=[-5, 20], ylim=[-5, 20], lognorm=True,
              savename='tripex/'+hydroset+'/pamtra3f_T<0.png', inverty=False, figax=None,
              bins=100)
...
hist_and_plot(radar.dropna(subset=['DWRxk', 'DWRkw']),
              ...
              xlabel='DWR Ka W   [dB]', ylabel='DWR X Ka   [dB]',
              xlim=[-5, 20], ylim=[-5, 20], lognorm=True,
              savename='tripex/'+hydroset+'/radar3f_all.png', inverty=False, figax=None,
              bins=100)
plt.plot(Zc[:,1]-Zc[:,2],Zc[:,0]-Zc[:,1], label='cloud droplets')
plt.plot(Zi[:,1]-Zi[:,2],Zi[:,0]-Zi[:,1], label='ice crystals')
plt.plot(Zr[:,1]-Zr[:,2],Zr[:,0]-Zr[:,1], label='raindrops')
...
plt.plot(Zg[:,1]-Zg[:,2],Zg[:,0]-Zg[:,1], label='graupel')
plt.plot(Zh[:,1]-Zh[:,2],Zh[:,0]-Zh[:,1], label='hail')
plt.savefig('tripex/'+hydroset+'/radar3f_all_withcurves.png')

hist_and_plot(slice_data(radar.dropna(subset=['DWRxk', 'DWRkw']), 'T', maxvalue=0),
              '3f plot T<0', yvar='DWRxk', xvar='DWRkw',
              xlabel='DWR Ka W   [dB]', ylabel='DWR X Ka   [dB]',
              xlim=[-5, 20], ylim=[-5, 20], lognorm=True,
              savename='tripex/'+hydroset+'/radar3f_T<0.png', inverty=False, figax=None,
              bins=100)
...
hist_and_plot(pamtra, 'CFAD DWRxk', yvar='T', xvar='DWRxk',
              ...
              savename='tripex/'+hydroset+'/pamtraCFAD_DWRxk_T.png',
              inverty=True, figax=None,
              bins=(100,100))
...
hist_and_plot(pamtra, 'CFAD DWRkw', yvar='T', xvar='DWRkw',
              ...
              savename='tripex/'+hydroset+'/pamtraCFAD_DWRkw_T.png',
              inverty=True, figax=None,
              bins=(100,100))
...
hist_and_plot(radar.dropna(subset=['DWRxk']),
              ...
              xlabel='DWRxk   [dB]', ylabel='T   [degC]',
              xlim=[-10, 20], ylim=[-20, 0], lognorm=True,
              savename='tripex/'+hydroset+'/radarCFAD_DWRxk_T.png',
              inverty=True, figax=None,
              bins=(100,100))
...
hist_and_plot(radar.dropna(subset=['DWRkw']),
              ...
              xlabel='DWRkw   [dB]', ylabel='T   [degC]',
              xlim=[-8, 13], ylim=[-20, 0], lognorm=True,
              savename='tripex/'+hydroset+'/radarCFAD_DWRkw_T.png',
              inverty=True, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(pamtra, 'DWRkw', 0, 2),
              ...
              savename='tripex/'+hydroset+'/pamtraSCAT_V_Z_DWRkw_0_2.png',
              inverty=True, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(pamtra, 'DWRkw', 2, 4),
              ...
              xlabel='Z X   [dBZ]', ylabel='MDV X [m/s]',
              xlim=[-60, 50], ylim=[-10, 0], lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_V_Z_DWRkw_2_4.png',
              inverty=True, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(pamtra, 'DWRxk', 4, 6),
              ...
              xlabel='Z X   [dBZ]', ylabel='MDV X [m/s]',
              xlim=[-60, 50], ylim=[-10, 0], lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_V_Z_DWRkw_4_6.png',
              inverty=True, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(pamtra, 'DWRkw', 6, 8),
              ...
              xlabel='Z X   [dBZ]', ylabel='MDV X [m/s]',
              xlim=[-60, 50], ylim=[-10, 0], lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_V_Z_DWRkw_6_8.png',
              inverty=True, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(pamtraTl0, 'DWRkw', 0, 2),
              ...
              xlabel='Z X   [dBZ]', ylabel='MDV X [m/s]',
              xlim=[-60, 50], ylim=[-10, 0], lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_V_Z_DWRkw_0_2_Tneg.png',
              inverty=True, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(pamtraTl0, 'DWRkw', 2, 4),
              ...
              xlabel='Z X   [dBZ]', ylabel='MDV X [m/s]',
              xlim=[-60, 50], ylim=[-10, 0], lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_V_Z_DWRkw_2_4_Tneg.png',
              inverty=True, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(radar.dropna(subset=['Z10','V10']), 'DWRkw', 0, 2),
              ...
              xlabel='Z X   [dBZ]', ylabel='MDV X [m/s]',
              xlim=[-60, 50], ylim=[-10, 0], lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_V_Z_DWRkw_0_2.png',
              inverty=True, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(radar.dropna(subset=['Z10','V10']), 'DWRkw', 2, 4),
              ...
              xlabel='Z X   [dBZ]', ylabel='MDV X [m/s]',
              xlim=[-60, 50], ylim=[-10, 0], lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_V_Z_DWRkw_2_4.png',
              inverty=True, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(radar.dropna(subset=['Z10','V10']), 'DWRxk', 4, 6),
              ...
              xlabel='Z X   [dBZ]', ylabel='MDV X [m/s]',
              xlim=[-60, 50], ylim=[-10, 0], lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_V_Z_DWRkw_4_6.png',
              inverty=True, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(radar.dropna(subset=['Z10','V10']), 'DWRkw', 6, 8),
              ...
              xlabel='Z X   [dBZ]', ylabel='MDV X [m/s]',
              xlim=[-60, 50], ylim=[-10, 0], lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_V_Z_DWRkw_6_8.png',
              inverty=True, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(radarTl0.dropna(subset=['Z10','V10']), 'DWRkw', 0, 2),
              ...
              xlabel='Z X   [dBZ]', ylabel='MDV X [m/s]',
              xlim=[-60, 50], ylim=[-10, 0], lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_V_Z_DWRkw_0_2_Tneg.png',
              inverty=True, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(radarTl0.dropna(subset=['Z10','V10']), 'DWRkw', 2, 4),
              ...
              xlabel='Z X   [dBZ]', ylabel='MDV X [m/s]',
              xlim=[-60, 50], ylim=[-10, 0], lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_V_Z_DWRkw_2_4_Tneg.png',
              inverty=True, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(pamtra, 'DWRkw', 0, 2),
              ...
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_W_Z_DWRkw_0_2.png',
...
hist_and_plot(slice_data(pamtra, 'DWRkw', 2, 4),
              ...
              xlabel='Z X   [dBZ]', ylabel='SW X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_W_Z_DWRkw_2_4.png',
              inverty=inverty, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(pamtra, 'DWRxk', 4, 6),
              ...
              xlabel='Z X   [dBZ]', ylabel='SW X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_W_Z_DWRkw_4_6.png',
              inverty=inverty, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(pamtra, 'DWRkw', 6, 8),
              ...
              xlabel='Z X   [dBZ]', ylabel='SW X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_W_Z_DWRkw_6_8.png',
              inverty=inverty, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(pamtraTl0, 'DWRkw', 0, 2),
              ...
              xlabel='Z X   [dBZ]', ylabel='SW X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_W_Z_DWRkw_0_2_Tneg.png',
              inverty=inverty, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(pamtraTl0, 'DWRkw', 2, 4),
              ...
              xlabel='Z X   [dBZ]', ylabel='SW X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_W_Z_DWRkw_2_4_Tneg.png',
              inverty=inverty, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(radar.dropna(subset=['Z10','W10']), 'DWRkw', 0, 2),
              ...
              xlabel='Z X   [dBZ]', ylabel='SW X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_W_Z_DWRkw_0_2.png',
              inverty=inverty, figax=None,
              bins=(65,65))
...
hist_and_plot(slice_data(radar.dropna(subset=['Z10','W10']), 'DWRkw', 2, 4),
              ...
              xlabel='Z X   [dBZ]', ylabel='SW X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_W_Z_DWRkw_2_4.png',
              inverty=inverty, figax=None,
              bins=(60,60))
...
hist_and_plot(slice_data(radar.dropna(subset=['Z10','W10']), 'DWRxk', 4, 6),
              ...
              xlabel='Z X   [dBZ]', ylabel='SW X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_W_Z_DWRkw_4_6.png',
              inverty=inverty, figax=None,
              bins=(60,60))
...
hist_and_plot(slice_data(radar.dropna(subset=['Z10','W10']), 'DWRkw', 6, 8),
              ...
              xlabel='Z X   [dBZ]', ylabel='SW X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_W_Z_DWRkw_6_8.png',
              inverty=inverty, figax=None,
              bins=(60,60))
...
hist_and_plot(slice_data(radarTl0.dropna(subset=['Z10','W10']), 'DWRkw', 0, 2),
              ...
              xlabel='Z X   [dBZ]', ylabel='SW X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_W_Z_DWRkw_0_2_Tneg.png',
              inverty=inverty, figax=None,
              bins=(45,45))
...
hist_and_plot(slice_data(radarTl0.dropna(subset=['Z10','W10']), 'DWRkw', 2, 4),
              ...
              xlabel='Z X   [dBZ]', ylabel='SW X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_W_Z_DWRkw_2_4_Tneg.png',
              inverty=inverty, figax=None,
              bins=(50,50))
...
h,x,y = hist_and_plot(slice_data(pamtra, 'T', 0),
              ...
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_V_DWRkw_T>0.png',
              inverty=inverty, figax=None,
              bins=(100,100))
...
plt.legend()
plt.savefig('tripex/'+hydroset+'/pamtraSCAT_V_DWRkw_T>0withcurves.png')

hist_and_plot(slice_data(radar, 'T', 0),
              'V10 vs DWRkw  |  T>0', yvar='V10', xvar='DWRkw',
              xlabel='DWRkw   [dB]', ylabel='V X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_V_DWRkw_T>0.png',
              inverty=inverty, figax=None,
              bins=(x,y))
plt.plot(Zi[:,1]-Zi[:,2], -Vi[:,0], label='ice crystals')
plt.plot(Zr[:,1]-Zr[:,2], -Vr[:,0], label='raindrops')
...
#plt.legend()
plt.savefig('tripex/'+hydroset+'/radarSCAT_V_DWRkw_T>0withcurves.png')
...
h,x,y = hist_and_plot(slice_data(pamtra, 'T', -5, 0),
              ...
              xlabel='DWRkw   [dB]', ylabel='V X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_V_DWRkw_T_-5_0.png',
              inverty=inverty, figax=None,
              bins=(100,100))
plt.plot(Zi[:,1]-Zi[:,2], -Vi[:,0], label='ice crystals')
plt.plot(Zr[:,1]-Zr[:,2], -Vr[:,0], label='raindrops')
...
plt.legend()
plt.savefig('tripex/'+hydroset+'/pamtraSCAT_V_DWRkw_-5_0withcurves.png')

hist_and_plot(slice_data(radar, 'T', -5, 0),
              'V10 vs DWRkw  |  -5<T<0', yvar='V10', xvar='DWRkw',
              xlabel='DWRkw   [dB]', ylabel='V X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_V_DWRkw_T_-5_0.png',
              inverty=inverty, figax=None,
              bins=(x,y))
plt.plot(Zi[:,1]-Zi[:,2], -Vi[:,0], label='ice crystals')
plt.plot(Zr[:,1]-Zr[:,2], -Vr[:,0], label='raindrops')
...
#plt.legend()
plt.savefig('tripex/'+hydroset+'/radarSCAT_V_DWRkw_-5_0withcurves.png')

h,x,y = hist_and_plot(slice_data(pamtra, 'T', -10, -5),
              'V10 vs DWRkw  |  -10<T<-5', yvar='V10', xvar='DWRkw',
              xlabel='DWRkw   [dB]', ylabel='V X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_V_DWRkw_T_-10_-5.png',
              inverty=inverty, figax=None,
              bins=(100,100))
plt.plot(Zi[:,1]-Zi[:,2], -Vi[:,0], label='ice crystals')
plt.plot(Zr[:,1]-Zr[:,2], -Vr[:,0], label='raindrops')
...
plt.plot(Zh[:,1]-Zh[:,2], -Vh[:,0], label='hail')
plt.legend()
plt.savefig('tripex/'+hydroset+'/pamtraSCAT_V_DWRkw_-10_-5withcurves.png')

hist_and_plot(slice_data(radar.dropna(), 'T', -10, -5),
              'V10 vs DWRkw  |  -10<T<-5', yvar='V10', xvar='DWRkw',
              xlabel='DWRkw   [dB]', ylabel='V X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_V_DWRkw_T_-10_-5.png',
              inverty=inverty, figax=None,
              bins=(80,80))
plt.plot(Zi[:,1]-Zi[:,2], -Vi[:,0], label='ice crystals')
plt.plot(Zr[:,1]-Zr[:,2], -Vr[:,0], label='raindrops')
...
plt.plot(Zg[:,1]-Zg[:,2], -Vg[:,0], label='graupel')
plt.plot(Zh[:,1]-Zh[:,2], -Vh[:,0], label='hail')
plt.savefig('tripex/'+hydroset+'/radarSCAT_V_DWRkw_-10_-5withcurves.png')

h,x,y = hist_and_plot(slice_data(pamtra.dropna(), 'T', -15, -10),
              'V10 vs DWRkw  |  -15<T<-10', yvar='V10', xvar='DWRkw',
              xlabel='DWRkw   [dB]', ylabel='V X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_V_DWRkw_T_-15_-10.png',
              inverty=inverty, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(radar.dropna(), 'T', -15, -10),
              ...
              xlabel='DWRkw   [dB]', ylabel='V X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_V_DWRkw_T_-15_-10.png',
              inverty=inverty, figax=None,
              bins=(72,72))
...
h,x,y = hist_and_plot(slice_data(pamtra.dropna(), 'T', -20, -15),
              ...
              xlabel='DWRkw   [dB]', ylabel='V X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_V_DWRkw_T_-20_-15.png',
              inverty=inverty, figax=None,
              bins=(100,100))
...
hist_and_plot(slice_data(radar.dropna(), 'T', -20, -15),
              ...
              xlabel='DWRkw   [dB]', ylabel='V X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_V_DWRkw_T_-20_-15.png',
              inverty=inverty, figax=None,
              bins=(40,40))
...
h,x,y = hist_and_plot(slice_data(pamtra, 'T', 0),
              ...
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_SW_DWRkw_T>0.png',
              inverty=inverty, figax=None,
              bins=(80,80))
...
hist_and_plot(slice_data(radar, 'T', 0),
              ...
              xlabel='DWRkw   [dB]', ylabel='SW X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_SW_DWRkw_T>0.png',
              inverty=inverty, figax=None,
              bins=(x,y))
...
h,x,y = hist_and_plot(slice_data(pamtra, 'T', -5, 0),
              ...
              xlabel='DWRkw   [dB]', ylabel='SW X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_SW_DWRkw_T_-5_0.png',
              inverty=inverty, figax=None,
              bins=(80,80))
...
plt.legend()
plt.savefig('tripex/'+hydroset+'/pamtraSCAT_SW_DWRkw_-5_0withcurves.png')

hist_and_plot(slice_data(radar, 'T', -5, 0),
              'SW10 vs DWRkw  |  -5<T<0', yvar='W10', xvar='DWRkw',
              xlabel='DWRkw   [dB]', ylabel='SW X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_SW_DWRkw_T_-5_0.png',
              inverty=inverty, figax=None,
              bins=(x,y))
plt.plot(Zi[:,1]-Zi[:,2], Si[:,0], label='ice crystals')
plt.plot(Zr[:,1]-Zr[:,2], Sr[:,0], label='raindrops')
...
plt.plot(Zg[:,1]-Zg[:,2], Sg[:,0], label='graupel')
plt.plot(Zh[:,1]-Zh[:,2], Sh[:,0], label='hail')
plt.savefig('tripex/'+hydroset+'/radarSCAT_SW_DWRkw_-5_0withcurves.png')

h,x,y = hist_and_plot(slice_data(pamtra.dropna(), 'T', -10, -5),
              'SW10 vs DWRkw  |  -10<T<-5', yvar='W10', xvar='DWRkw',
              xlabel='DWRkw   [dB]', ylabel='SW X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_SW_DWRkw_T_-10_-5.png',
              inverty=inverty, figax=None,
              bins=(80,80))
plt.plot(Zi[:,1]-Zi[:,2], Si[:,0], label='ice crystals')
plt.plot(Zr[:,1]-Zr[:,2], Sr[:,0], label='raindrops')
...
plt.plot(Zh[:,1]-Zh[:,2], Sh[:,0], label='hail')
plt.legend()
plt.savefig('tripex/'+hydroset+'/pamtraSCAT_SW_DWRkw_-10_-5withcurves.png')

hist_and_plot(slice_data(radar.dropna(), 'T', -10, -5),
              'SW10 vs DWRkw  |  -10<T<-5', yvar='W10', xvar='DWRkw',
              xlabel='DWRkw   [dB]', ylabel='SW X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_SW_DWRkw_T_-10_-5.png',
              inverty=inverty, figax=None,
              bins=(x,y))
plt.plot(Zi[:,1]-Zi[:,2], Si[:,0], label='ice crystals')
plt.plot(Zr[:,1]-Zr[:,2], Sr[:,0], label='raindrops')
...
plt.plot(Zg[:,1]-Zg[:,2], Sg[:,0], label='graupel')
plt.plot(Zh[:,1]-Zh[:,2], Sh[:,0], label='hail')
plt.savefig('tripex/'+hydroset+'/radarSCAT_SW_DWRkw_-10_-5withcurves.png')

h,x,y = hist_and_plot(slice_data(pamtra, 'T', -15, -10),
              'SW10 vs DWRkw  |  -15<T<-10', yvar='W10', xvar='DWRkw',
              xlabel='DWRkw   [dB]', ylabel='SW X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/pamtraSCAT_SW_DWRkw_T_-15_-10.png',
              inverty=inverty, figax=None,
              bins=(80,80))
...
hist_and_plot(slice_data(radar.dropna(), 'T', -15, -10),
              ...
              xlabel='DWRkw   [dB]', ylabel='SW X [m/s]',
              xlim=xlim, ylim=ylim, lognorm=True,
              savename='tripex/'+hydroset+'/radarSCAT_SW_DWRkw_T_-15_-10.png',
              inverty=inverty, figax=None,
              bins=(x,y))
